...
extern void lna_ui_buffer_new_rect  (lna_ui_buffer_t* buffer, const lna_ui_buffer_rect_config_t* config);
extern void lna_ui_buffer_new_text  (lna_ui_buffer_t* buffer, const lna_ui_buffer_text_config_t* config);
