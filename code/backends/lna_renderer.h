#ifndef LNA_BACKENDS_LNA_RENDERER_H
#define LNA_BACKENDS_LNA_RENDERER_H
...
extern void lna_renderer_draw_frame (lna_renderer_t* renderer, bool window_resized, uint32_t window_width, uint32_t window_height);
